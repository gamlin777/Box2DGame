...
namespace octet {
  ...
  public:
    ...
    void render(texture_shader &shader, mat4t &cameraToWorld) {
      ...
      modelToWorld.rotateZ(body->GetAngle() * (0.0f));
  ...
  public:
    ...
    void app_init() {
      ...
      bounce = resources::get_sound_handle(AL_FORMAT_MONO16, "assets/invaderers/bounce.wav");
      cur_source = 0;
	  ...
	  b2FixtureDef circle_def;
      fixture_def.restitution = 1.1f; // bouncy
	  circle_def.restitution = 1.1f;
      circle_def.shape = &circleShape;
      ...
      //    body_def.position.x = i - 0.0f ;
      //    body_def.position.y =  i + 3.0f;
      //    body_def.angle = i  * 2.0f;
      //    sprites.push_back(
      ...
      poly.SetAsBox(5.0f, 0.5f);
  	  body_def.type = b2_staticBody;

       //Top Court
      body_def.angle = (0.0f/180) * 20;
	  ...
	  poly.SetAsBox(0.5f, 5.0f);
  	  body_def.type = b2_staticBody;

	  //Right Court
	  body_def.angle = (0.0f/180) * 20;
      body_def.position.Set(5, 0);
      sprites.push_back(
      new sprite_2d(box2d_world, body_def, fixture_def, invaderer));
